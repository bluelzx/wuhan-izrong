    ...
    return (
      ...
      item:item
        ...
        <View
          ...
          <Text numberOfLines={1} style={{color:'#343C40',fontWeight:'bold',fontSize:16}}>{item.title}</Text>
          <Text numberOfLines={3} style={{color:'#8694A0', marginTop:15}}>{item.content}</Text>
          <View
            style={{flexDirection:'row', justifyContent:'space-between',marginTop:10,borderTopWidth:0.5,borderTopColor:'#EBECF3',paddingTop:10}}>
