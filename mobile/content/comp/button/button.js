...
var _coalesceNonElementChildren = (children, coalesceNodes) => {
...
var Button = React.createClass({
  ...
  _renderGroupedChildren() {
    ...
    var children = _coalesceNonElementChildren(this.props.children, (children, index) => {
      return (
