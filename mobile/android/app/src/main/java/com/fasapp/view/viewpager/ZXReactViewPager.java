    ...
    private class PageChangeListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            mEventDispatcher.dispatchEvent(
                    new com.fasapp.view.viewpager.PageScrollEvent(getId(), SystemClock.uptimeMillis(), position, positionOffset));
        }
        ...
        public void onPageSelected(int position) {
            if (!mIsCurrentItemFromJs) {
                mEventDispatcher.dispatchEvent(
                        new com.fasapp.view.viewpager.PageSelectedEvent(getId(), SystemClock.uptimeMillis(), position));
            }
        }
